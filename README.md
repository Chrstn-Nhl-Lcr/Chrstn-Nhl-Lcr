📄 PHP Forms Overview
- PHP 1 – Add User Form
A straightforward form where you can input a full name and email address, then save the details. It includes a "View Users" link to check the list of added users. Styled with simple CSS for clean spacing and button design.
- PHP 2 – Registration Form
